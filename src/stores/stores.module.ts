...
import { PaymentMethod, PaymentMethodSchema } from './infraestructure/database/mongo-db/schemas/payment-method.schema';
import { Store, StoreSchema } from './infraestructure/database/mongo-db/schemas/store.schema';
@Module({
  imports: [
